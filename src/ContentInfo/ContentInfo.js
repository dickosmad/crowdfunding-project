...
import BackedModal from "../BackedModal/BackedModal";
...
export default function ContentInfo() {
  ...
  return (
    <>
      <div className="container">
        <div className="monitor_riser">
          ...
          <div className="monitor_select">
            <div>
              <button onClick={() => setPopup(true)}>Back this project</button>
            </div>
      ...
      <section className="modal__component">
        <BackedModal trigger={popup} setTrigger={setPopup} />
      </section>
    </>
  );
}
